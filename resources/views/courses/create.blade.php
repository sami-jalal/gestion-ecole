            ...
            <form method="POST" action="{{url('courses')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <input type="text" name="title" class="form-control form-control-sm" id="title" required aria-describedby="titleHelp" value="{{old('title')}}">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <textarea id="description" name="description" class="form-control form-control-sm" rows="3" aria-describedby="descriptionHelp">{{old('description')}}</textarea>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <input type="file" name="file" class="form-control form-control-sm" id="file" required aria-describedby="fileHelp" value="{{old('file')}}">
